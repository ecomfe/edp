 ...
 * @return {string} 带上输出颜色信息的文字
 */
function getOutputText( text, status ) {
    var color = 'white';
...
function outputMessage( message ) {
    ...
    if ( message.line && message.col ) {
        position = getOutputText( '[L' + message.line + ',C' + message.col + '] ', 'info' );
    }
    ...
    console.log( position + getOutputText( failInfo, message.type ) );
