...
var DEFAULT_MANIFEST = {
    ...
    libDir: 'lib',
    srcDir: 'src',
    loaderAutoConfig: 'js,htm,html,tpl,vm',
    loaderBaseUrl: 'src',
    loaderPaths: {}
};
 ...
 * @param {string=} basePath 目录路径
 */
exports.createManifestFile = function ( projectDir ) {
    var fs = require( 'fs' );
    var path = require( 'path' );
    ...
    if ( !fs.existsSync( file ) ) {
        ...
        manifest.loaderUrl = require( './config' ).get( 'loader.url' );
        fs.writeFileSync( 
            file, 
...
exports.init = function ( basePath ) {
    ...
    exports.createManifestFile( basePath );
