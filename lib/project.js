 ...
 * @type {string}
 */
var DEFAULT_LOADER = 'http://s1.bdstatic.com/r/www/cache/ecom/esl/1-4-0/esl.js';
...
exports.createMetadataFile = function ( projectDir ) {
    ...
    if ( !fs.existsSync( mdFile ) ) {
        ...
        metadata.loaderUrl = edpConfig.get( 'loader.url' ) || DEFAULT_LOADER;
