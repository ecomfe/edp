    ...
    fs.readdirSync( dir )
        ...
        .forEach(
            function ( file ) {
                ...
                else if ( stat.isDirectory() && ( name === 'src' || name === 'lib' ) ) {
...
exports.getCommandModule = function( pkg, args ) {
    ...
    var rootCommandNode = new CommandNode( require( pkg ) );
...
exports.parse = function ( args ) {
    ...
    function done() {
        ...
        if ( commandModule.cli && typeof commandModule.cli.main === 'function' ) {
            ...
            if ( x.opts.help === true ) {
                // FIXME
                console.log( 'Show help commandModule.cli.main' );
            }
            else {
